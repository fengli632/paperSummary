...
<body>
	...
	<div class=paper-box>
<span class="title-span">更新论文类别</span>
	<div class="paper-content">
		...
		<div class="input-field">
			<div class="input-field-content">
				<sf:input path="categoryName" class="input-field"/>
				<%-- <span class="input-locked">${paperCategory.categoryName }</span>
				<sf:hidden class="input-field" path="categoryName"/>   --%>
			</div>
		</div> 
